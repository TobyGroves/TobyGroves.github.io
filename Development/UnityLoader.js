...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'numero une.data';
    var REMOTE_PACKAGE_BASE = 'numero une.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2390291;
      var PACKAGE_UUID = '8ccfd96e-aa5c-4318-9634-2e29c276a6a3';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 64383, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(64383, 64404, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(64404, 64690, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(64690, 1487694, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1487694, 2362666, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2362666, 2390291, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_numero une.data');

    };
    Module['addRunDependency']('datafile_numero une.data');
